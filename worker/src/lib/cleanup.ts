...
// handler in index.ts). Four jobs, all idempotent and all bounded so one run
...
//   3. orphan media — an upload that was presigned (or even completed) but
...
//   4. retention — deletes claimed media older than MEDIA_RETENTION_DAYS.
