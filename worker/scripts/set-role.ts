...
//
// Migration 0003 grants "owner" to the `good` account automatically. Any other
// instance names its owner here. There is no bootstrap endpoint on purpose:
// promoting an account is a D1 write, and D1 writes need the deploy key.
